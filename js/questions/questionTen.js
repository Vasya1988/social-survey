const questionTen = () => {
    const markupQuestionTen = `
        ...
        <div class='nav-button'>
            <span>67%</span>
            <div class="buttons">
                <a href='#/q9' type="button" class='button' >Назад</a>
                <a href='#/q11' type="button" class='button' >Вперед</a>
            </div>
        </div>
    ...
    const renderPage = () => {
        document.getElementById('app').insertAdjacentHTML('afterbegin', markupQuestionTen)
    }
